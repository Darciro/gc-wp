 ...
 * Description: Easy to add and display history OR timeline for your WordPress website. Also support WordPress POST post type. Also work with Gutenberg shortcode block. 
...
if( !defined('WPOSTAHS_VERSION') ) {
	define( 'WPOSTAHS_VERSION', '1.3.2' ); // Plugin version
}
	...
	$wpos_analytics =  wpos_anylc_init_module( array(
							...
							'offers'		=> array(
													'trial_premium' => array(
														...
														'link'	=> 'http://analytics.wponlinesupport.com/?anylc_redirect=43',
