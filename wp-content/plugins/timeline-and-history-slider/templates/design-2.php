<div id="wpostahs-slider-nav-<?php echo $unique; ?>" class="wpostahs-slider-nav-<?php echo $unique; ?> wpostahs-slider-nav wpostahs-slick-slider" <?php echo $slider_as_nav_for; ?> background-image: url("<?php echo $feat_image[0]; ?>"); >	
	<?php while ( $query->have_posts() ) : $query->the_post();
		...
		<div class="wpostahs-slider-nav-title">
			...
			<?php if( !empty($feat_image) and false ) { ?>
				<img src="<?php echo $feat_image[0]; ?>" alt="<?php echo the_title(); ?>" />				
			<?php } echo the_title(); ?>
			</div>
		</div>
	<?php endwhile; ?>
