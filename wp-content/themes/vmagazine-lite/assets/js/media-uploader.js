...
function vmagazine_lite_add_file(event, selector) {
   ...
   vmagazine_lite_selector = selector;
    ...
    if (vmagazine_lite_upload ) {
       ...
       vmagazine_lite_upload = wp.media.frames.vmagazine_upload =  wp.media({
       ...
       vmagazine_lite_upload.on( 'select', function() {
           ...
           vmagazine_lite_selector.find('.ap-upload-button').unbind().addClass('remove-file').removeClass('ap-upload-button').val(vmagazine_l10n.remove);
...
function vmagazine_lite_remove_file(selector) {
    ...
    selector.find('.remove-file').unbind().addClass('ap-upload-button').removeClass('remove-file').val(vmagazine_l10n.upload);
