...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="archive-wrapper">
        ...
        $img_src = vmagazine_lite_home_element_img('vmagazine-vertical-slider-thumb');
		...
		<div class="list-left-wrap">
			...
			<div class="entry-content">
				...
				<?php
					...
					echo vmagazine_lite_get_excerpt_content( $vmagazine_excerpt_length ); // WPCS: XSS OK.
				?>
				</p>
				<?php 
					$vmagazine_read_more_txt = get_theme_mod( 'vmagazine_archive_read_more_text', __( 'Read More', 'vmagazine-lite' ) );
				 ?>		
