...
if ( ! function_exists( 'vmagazine_lite_setup' ) ) :
	...
	add_image_size( 'vmagazine-large-square-thumb', 540, 519, true );
...
function vmagazine_lite_scripts() {
	...
	wp_register_script( 'vmagazine-custom-script',VMAG_URI.'/assets/js/vmagazine-lite-custom.js', array( 'jquery' ), VMAG_VER, true );
	...
	*/
    ...
    wp_localize_script( 'vmagazine-custom-script', 'vmagazine_lite_ajax_script', $localize_options  );
...
/*===============================================================================================================================*/
    ...
    wp_enqueue_style( 'vmagazine-google-fonts', add_query_arg( $vmagazine_lite_font_args, "//fonts.googleapis.com/css" ) );
