...
jQuery(document).ready(function ($) {
	...
	$(".plugin-btn-wrapper .install").on('click', function (e) {
		...
		$.ajax({
			...
			url: ajaxurl,
			data: {
				action: 'vmagazine_lite_plugin_installer',
				plugin: plugin,
	...
	$('.install-offline').on('click', function (e) {
		...
		$.ajax({
			...
			url: ajaxurl,
			data: {
				action: 'vmagazine_lite_plugin_offline_installer',
	...
	$(".activate").on('click', function (e) {
		...
		$.ajax({
	   		...
	   		url: ajaxurl,
	   		data: {
	   			action: 'vmagazine_lite_plugin_activation',
	   			plugin: plugin,
	...
	$('.activate-offline').on('click', function (e) {
		...
		$.ajax({
	   		...
	   		url: ajaxurl,
	   		data: {
	   			action: 'vmagazine_lite_plugin_offline_activation',
	   			plugin: plugin,
	   			nonce: VmagazineWelcomeObject.activate_nonce,
	   			dataType: 'json'
	   		},
