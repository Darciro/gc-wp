...
class vmagazine_lite_tab_posts_list extends WP_Widget {
    ...
    private function widget_fields() {
        ...
        $fields = array(
             ...
             'block_post_layout' => array(
                ...
                'vmagazine_widgets_layout_img'   => VMAG_WIDGET_IMG_URI.'fws-2.png',
    ...
    ?>
        <div class="vmagazine-fullwid-slider block-post-wrapper block_layout_2" data-count="<?php echo absint($vmagazine_block_posts_count);?>">
            ...
            <?php 
                ...
                if( $block_query->have_posts() ) {
                    while( $block_query->have_posts() ) {
                        ...
                        $img_src = vmagazine_lite_home_element_img('vmagazine-single-large');
                ...
                <?php 
                    ...
                    if( $block_query->have_posts() ) {
                        while( $block_query->have_posts() ) {
                            $block_query->the_post();
                            $image_id = get_post_thumbnail_id();
                            $img_srcs = vmagazine_lite_home_element_img('vmagazine-small-thumb');
                            $image_alt = get_post_meta( $image_id, '_wp_attachment_image_alt', true );
                ?>                
                <div class="single-post clearfix">  
