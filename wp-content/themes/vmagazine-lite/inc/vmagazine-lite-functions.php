...
if( ! function_exists( 'vmagazine_lite_news_ticker_hook' ) ):
    function vmagazine_lite_news_ticker_hook() {
        ...
        $vmagazine_ticker_caption = get_theme_mod( 'vmagazine_ticker_caption', esc_html__( 'Recent News', 'vmagazine-lite' ) );
...
*
*/
add_action('vmagazine_formated_date','vmagazine_lite_formated_date');
...
function vmagazine_lite_body_classes( $classes ) {
    ...
    if( (is_archive() || is_home() || is_search() ) ){
        $classes[] = 'vmagazine-archive-layout1' ;
    }
