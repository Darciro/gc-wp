...
if( !function_exists( 'vmagazine_lite_related_posts_hook' ) ):
    function vmagazine_lite_related_posts_hook() {
        ...
        $vmagazine_related_post_title = get_theme_mod( 'vmagazine_related_posts_title', esc_html__( 'Related Articles', 'vmagazine-lite' ) );
                        ...
                        <div class="single-post">
                            ...
                            <div class="related-content-wrapper">
                                ...
                                <div class="post-contents">
                                    <?php echo vmagazine_lite_get_excerpt_content( absint($vmagazine_related_post_excerpt)) // WPCS: XSS ok. ?> 
                                </div>   
...
if( ! function_exists( 'vmagazine_lite_menu_random_icon_hook' ) ):
    ...
    ?>
                <a href="<?php the_permalink(); ?>" class="icon-random" title="<?php esc_html_e( 'View a random post', 'vmagazine-lite' ); ?>">
    ...
    function vmagazine_lite_mob_nav_logo(){
        ...
        if( $vmagazine_mobile_header_logo ){ ?>
            <a href="<?php echo esc_url(home_url('/'));?>">
                <img src="<?php echo esc_url($vmagazine_mobile_header_logo);?>" alt="<?php echo esc_attr($image_alt);?>" >
            </a>
        <?php
        }else{
            the_custom_logo();
