...
if(! function_exists('vmagazine_lite_nav_header')){
	...
	<div class="vmagazine-nav-wrapper">
		<div class="vmagazine-container clearfix">			
			...
			if ( function_exists( 'vmagazine_lite_woocommerce_header_cart')  && ($vmagazine_cart_show == 'show')  ) {
		...
		<div class="vmagazine-container">			
			<nav class="main-navigation clearfix" >
				<div class="nav-wrapper">
		            ...
		            <?php vmagazine_lite_home_icon(); ?>
					<?php wp_nav_menu( array( 'theme_location' => 'primary_menu','container_class'=>'menu-mmnu-container', 'menu_id' => 'primary-menu', 'fallback_cb' => 'vmagazine_lite_wp_page_menu','menu_class' => 'vmagazine_mega_menu' ) ); ?>
				</div><!-- .nav-wrapper -->
			</nav><!-- #site-navigation -->
...
if ( ! function_exists( 'vmagazine_lite_credit' ) ) {
	...
	function vmagazine_lite_credit() {
		?>
				<div class="site-info">
					<?php $copyright = get_theme_mod( 'vmagazine_copyright_text' ); 
					if( !empty( $copyright ) ) { 
