...
*/
  function vmagazine_lite_enqueue_repeater_scripts() {
    wp_enqueue_script( 'vmagazine-pro-repeater-script', get_template_directory_uri() . '/inc/customizer/repeater-controller/repeater-script.js',array( 'jquery','jquery-ui-sortable'));
...
$wp_customize->add_control(  new vmagazine_lite_Repeater_Controler( $wp_customize, 'vmagazine_social_icons', 
    array(
        'label'                     => esc_html__('Social Icons Option','vmagazine-lite'),
        'section'                   => 'vmagazine_header_icons',
        'vmagazine_box_label'         => esc_html__('Social Icons','vmagazine-lite'),
        'vmagazine_box_add_control'   => esc_html__('Add Profile','vmagazine-lite'),
    ),
        array(
            'social_icons' => array(
            'type'        => 'social_icon',
