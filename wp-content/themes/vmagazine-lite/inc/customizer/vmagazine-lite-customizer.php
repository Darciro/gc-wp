...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,'vmagazine_theme_color', array(
            ...
            'section'       => 'colors',
            'settings'      => 'vmagazine_theme_color',
            'priority'      => 15
)));
...
$wp_customize->add_control( new vmagazine_lite_Customize_Icons_Control( $wp_customize, 'vmagazine_home_icon_picker', array(
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_header_search_enable',array(
  'type'      => 'switch',                    
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_ajax_search_enable',array(
  'type'      => 'switch',                    
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_cart_show',  array(
  'type'      => 'switch',                    
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_header_icon_show',  array(
  'type'      => 'switch',                    
...
$wp_customize->add_control( new vmagazine_lite_Bg_Color_Picker( $wp_customize,'vmagazine_mobile_header_bg_color', array(
...
$wp_customize->add_control( new vmagazine_lite_Image_Radio_Control($wp_customize, 'vmagazine_archive_sidebar', array(
		'type'			  => 'radio',
...
$wp_customize->add_control( new vmagazine_lite_Image_Radio_Control($wp_customize,'vmagazine_default_post_sidebar',array(
		'type' 			  => 'radio',
		'label' 		  => esc_html__( 'Available Sidebars', 'vmagazine-lite' ),
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control($wp_customize, 'vmagazine_post_share_option', array(
            'type'        => 'switch',                  
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control($wp_customize,'vmagazine_related_posts_option', array(
            'type' 			  => 'switch',	                
 ...
 * Page Settings
 */
$wp_customize->add_section('vmagazine_page_settings_section',array(
...
$wp_customize->add_control( new vmagazine_lite_Image_Radio_Control($wp_customize, 'vmagazine_default_page_sidebar', array(
		'type' 			  => 'radio',
		'label' 		  => esc_html__( 'Available Sidebars', 'vmagazine-lite' ),
    'description' => esc_html__( 'Select sidebar for every pages.', 'vmagazine-lite' ),
		'section' 		=> 'vmagazine_page_settings_section',
    'priority'  	=> 5,
		'choices' 		=> array(
			'right_sidebar' => get_template_directory_uri() . '/assets/images/right-sidebar.png',
            'left_sidebar' 	=> get_template_directory_uri() . '/assets/images/left-sidebar.png',
...
$wp_customize->add_section( 'vmagazine_buttom_footer_option', array(
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_buttom_footer_menu',  array(
	  'type'      => 'switch',                    
	  'label'     => esc_html__( 'Hide / Show Footer Menu', 'vmagazine-lite' ),
	  'section'   => 'vmagazine_buttom_footer_option',
	  'priority'  => 7,
	  'choices'   => array(
	        'show'  => esc_html__( 'Show', 'vmagazine-lite' ),
	        'hide'  => esc_html__( 'Hide', 'vmagazine-lite' )
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control( $wp_customize, 'vmagazine_buttom_footer_icons',  array(
  'type'      => 'switch',                    
  'label'     => esc_html__( 'Hide / Show Social Icons', 'vmagazine-lite' ),
  'section'   => 'vmagazine_buttom_footer_option',
...
$wp_customize->add_control( new vmagazine_lite_Textarea_Custom_Control($wp_customize,'vmagazine_copyright_text',array(
...
$wp_customize->add_control( new vmagazine_lite_Textarea_Custom_Control($wp_customize,'vmagazine_description_text',array(
            'type'      => 'vmagazine_textarea',
...
$wp_customize->add_control( new vmagazine_lite_Customize_Switch_Control($wp_customize, 'vmagazine_ticker_option', array(
            'type' 			    => 'switch',
